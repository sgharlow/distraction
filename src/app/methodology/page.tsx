  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-[820px] px-4 py-6">
        ...
        <p className="mb-5 text-[11.5px] text-text-muted">Full algorithmic transparency.</p>

        {/* What's new */}
        <section className="bg-live/[0.04] border border-live/15 rounded-lg p-3 mb-3">
          <h2 className="text-[11.5px] font-bold text-live mb-1">New in v2.2 — Weekly Editions</h2>
        ...
        <div className="space-y-2.5">
          ...
          <section className="bg-damage/[0.03] border border-damage/[0.08] rounded-lg p-3">
            <h2 className="text-xs font-bold text-damage mb-1">List A — Constitutional Damage</h2>
            <p className="text-[10.5px] text-text-secondary leading-relaxed mb-3">
              7 weighted drivers scored 0–5, combined with severity multipliers, mechanism modifier,
              and scope modifier.
            </p>
            <div className="font-mono text-[10px] text-damage-light bg-damage/[0.05] rounded p-2 mb-3">
              A = min(100, 100 × Σ(weight × driver / 5) × avg(severity) × mechanism × scope)
            </div>

            <h3 className="text-[10px] font-bold text-damage mb-1.5 uppercase tracking-wider">
              Drivers & Weights
            </h3>
            <div className="space-y-0.5 mb-3">
              {A_DRIVER_KEYS.map((key) => (
                <div key={key} className="flex justify-between text-[10.5px]">
            ...
            <ul className="text-[10.5px] text-text-secondary space-y-0.5 list-none p-0 m-0 mb-3">
          ...
          <section className="bg-distraction/[0.03] border border-distraction/[0.08] rounded-lg p-3">
            <h2 className="text-xs font-bold text-distraction mb-1">List B — Distraction/Hype</h2>
            <p className="text-[10.5px] text-text-secondary leading-relaxed mb-3">
            ...
            <div className="font-mono text-[10px] text-distraction-light bg-distraction/[0.05] rounded p-2 mb-3">
              B = 100 × (0.55 × L1_avg/5 + intent_weight × L2_avg/5)
            </div>

            <h3 className="text-[10px] font-bold text-distraction mb-1 uppercase tracking-wider">
              Intentionality Thresholds
            </h3>
            <div className="text-[10.5px] text-text-secondary space-y-0.5 mb-3">
          ...
          <section className="bg-mixed/[0.03] border border-mixed/[0.08] rounded-lg p-3">
            <h2 className="text-xs font-bold text-mixed mb-1">Classification & Dominance Margin</h2>
          ...
          <section className="bg-[#7C3AED06] border border-[#7C3AED18] rounded-lg p-3">
            <h2 className="text-xs font-bold text-mixed-light mb-1">Smokescreen Index</h2>
            ...
            <div className="font-mono text-[10px] text-mixed-light bg-mixed/[0.05] rounded p-2">
          ...
          <section className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
            <h2 className="text-xs font-bold text-text-muted mb-1">Weekly Freeze Policy</h2>
            <p className="text-[10.5px] text-text-secondary leading-relaxed">
